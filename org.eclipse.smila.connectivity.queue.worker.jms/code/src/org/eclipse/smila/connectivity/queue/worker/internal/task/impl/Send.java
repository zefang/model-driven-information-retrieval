...
public class Send extends AbstractTask<SendType> {
  ...
  public String[] executeInternal(final TaskExecutionEnv env, final SendType config,
    final Map<String, Properties> idPropertyMap) throws TaskExecutionException, BlackboardAccessException,
   ...
   */
  private Record createMessageRecord(final String id, final SendType config, final TaskExecutionEnv env)
