...
import it.polimi.mdir.crawler.uml.messages.Attribute;
import it.polimi.mdir.crawler.uml.messages.Process.Filter;
import it.polimi.mdir.crawler.uml.messages.Process.Filter.Exclude;
import it.polimi.mdir.crawler.uml.messages.Process.Filter.Include;
...
/**
 * The Class UmlCrawler.
 */
public class UmlCrawler extends AbstractCrawler {
  ...
  public UmlCrawler() {
    super();
    _log.write("[DEBUG] Creating UmlCrawler instance");
  }
  ...
  public void initialize(final DataSourceConnectionConfig config) throws CrawlerException, CrawlerCriticalException {
    _log.write("[INFO] Initializing UmlCrawler...");
    ...
    _performanceCounters =
      new CrawlerPerformanceCounterHelper<UmlCrawlerPerformanceAgent>(config, hashCode(),
        UmlCrawlerPerformanceAgent.class);
  ...
  private void checkFolders(final DataSourceConnectionConfig config) throws CrawlerCriticalException {
    final it.polimi.mdir.crawler.uml.messages.Process process = (it.polimi.mdir.crawler.uml.messages.Process) config.getProcess();
  ...
  public void close() throws CrawlerException {
    synchronized (_openedMonitor) {
      _opened = false;
      _log.write("[INFO] Closing UmlCrawler...");
      _forceClosing = true;
  ...
  private class CrawlingProducerThread extends Thread {
     ...
     * The _process.
     */
    private final it.polimi.mdir.crawler.uml.messages.Process _process;
    ...
    public CrawlingProducerThread(final CrawlerCallback crawlerCallback,
      ...
      _process = (it.polimi.mdir.crawler.uml.messages.Process) process;
