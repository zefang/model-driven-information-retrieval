...
import org.eclipse.smila.datamodel.test.RecordCreator;
...
public class Activator implements BundleActivator {
   ...
   * 
   * @throws Exception
   *           router and parser exception
   */
  private void route(final Router router, final int index) throws Exception {
    _log.info("Routing record " + index + "...");
    final Record record = RecordCreator.createTestRecord1();
    record.setId("key" + index);
