...
public interface DeltaIndexingManager {
   ...
   *           the delta indexing exception
   */
  boolean checkForUpdate(final String sessionId, final ConnectivityId id, final String hash)
   ...
   *           the delta indexing exception
   */
  void visit(final String sessionId, final ConnectivityId id, final String hash, final boolean isCompound)
    throws DeltaIndexingSessionException, DeltaIndexingException;
   ...
   *           the delta indexing exception
   */
  Iterator<ConnectivityId> obsoleteIdIterator(final String sessionId, final String dataSourceID)
    throws DeltaIndexingSessionException, DeltaIndexingException;
   ...
   *           the delta indexing exception
   */
  Iterator<ConnectivityId> obsoleteIdIterator(final String sessionId, final ConnectivityId id)
    throws DeltaIndexingSessionException, DeltaIndexingException;
   ...
   *           the delta indexing exception
   */
  void delete(final String sessionId, final ConnectivityId id) throws DeltaIndexingSessionException,
