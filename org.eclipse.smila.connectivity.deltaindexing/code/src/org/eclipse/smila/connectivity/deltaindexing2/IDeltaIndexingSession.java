...
public interface IDeltaIndexingSession {
   ...
   *           the delta indexing exception
   */
  void delete(final ConnectivityId id) throws DeltaIndexingSessionException, DeltaIndexingException;
   ...
   *           the delta indexing exception
   */
  boolean hasChanged(final ConnectivityId id, final String hash) throws DeltaIndexingSessionException,
   ...
   *           the delta indexing exception
   */
  void touch(final ConnectivityId id, final String hash, final boolean isCompound)
   ...
   *           the delta indexing exception
   */
  boolean checkAndTouch(final ConnectivityId id, final String hash, final boolean isCompound)
    throws DeltaIndexingSessionException, DeltaIndexingException;
