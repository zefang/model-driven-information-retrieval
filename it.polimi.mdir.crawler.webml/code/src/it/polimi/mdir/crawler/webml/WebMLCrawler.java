...
import it.polimi.mdir.crawler.webml.messages.Attribute;
import it.polimi.mdir.crawler.webml.messages.Process.Filter;
import it.polimi.mdir.crawler.webml.messages.Process.Filter.Exclude;
import it.polimi.mdir.crawler.webml.messages.Process.Filter.Include;
...
public class WebMLCrawler extends AbstractCrawler {
  ...
  public void initialize(final DataSourceConnectionConfig config) throws CrawlerException, CrawlerCriticalException {
    ...
    _performanceCounters =
      new CrawlerPerformanceCounterHelper<WebMLCrawlerPerformanceAgent>(config, hashCode(),
        WebMLCrawlerPerformanceAgent.class);
  ...
  private void checkFolders(final DataSourceConnectionConfig config) throws CrawlerCriticalException {
    final it.polimi.mdir.crawler.webml.messages.Process process = (it.polimi.mdir.crawler.webml.messages.Process) config.getProcess();
  ...
  private class CrawlingProducerThread extends Thread {
     ...
     * The _process.
     */
    private final it.polimi.mdir.crawler.webml.messages.Process _process;
    ...
    public CrawlingProducerThread(final CrawlerCallback crawlerCallback,
      ...
      _process = (it.polimi.mdir.crawler.webml.messages.Process) process;
