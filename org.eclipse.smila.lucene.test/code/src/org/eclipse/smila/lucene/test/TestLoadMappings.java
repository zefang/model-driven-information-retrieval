...
public class TestLoadMappings extends TestCase {
  ...
  public void testLoadMappingsMap() throws Exception {
    ...
    assertEquals(NUMBER_5, attributeMap.size());
   ...
   *           if any error occurs
   */
  private void checkMapping1(final Mapping mapping) throws Exception {
    ...
    assertEquals(NUMBER_5, attributesList.size());
   ...
   *           if any error occurs
   */
  private void checkMapping2(final Mapping mapping) throws Exception {
    assertNotNull(mapping);
