 ...
 *
 */
public class Test1Pipelet implements Pipelet {
  /**
   * local logger.
   */
  private final Log _log = LogFactory.getLog(Test1Pipelet.class);
  ...
  public void configure(final AnyMap configuration) throws ProcessingException {
    _log.info("Test1Pipelet.configure():" + configuration);
  }
  ...
  public String[] process(final Blackboard blackboard, final String[] recordIds) throws ProcessingException {
    _log.info("Test1Pipelet.process():" + recordIds);
    return recordIds;
  }
}
