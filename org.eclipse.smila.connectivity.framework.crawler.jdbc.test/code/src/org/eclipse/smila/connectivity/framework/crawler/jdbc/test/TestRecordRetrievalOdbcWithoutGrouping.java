 ...
 * 
 */
public class TestRecordRetrievalOdbcWithoutGrouping extends AbstractDataEnabledJdbcCrawlerTestCase {
  ...
  public void testRecordRetrieval() throws Exception {
    ...
    final DataSourceConnectionConfig config =
      ConfigurationLoader.unmarshall(TestConfigLoad.class.getResourceAsStream("JdbcOdbcWithoutGrouping.xml"));
