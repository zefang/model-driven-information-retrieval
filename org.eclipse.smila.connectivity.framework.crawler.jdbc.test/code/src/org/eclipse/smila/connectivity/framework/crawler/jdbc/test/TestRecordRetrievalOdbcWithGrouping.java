 ...
 * 
 */
public class TestRecordRetrievalOdbcWithGrouping extends AbstractDataEnabledJdbcCrawlerTestCase {
  ...
  public void testRecordRetrieval() throws Exception {
    ...
    final DataSourceConnectionConfig config =
      ConfigurationLoader.unmarshall(TestConfigLoad.class.getResourceAsStream("JdbcOdbcWithGrouping.xml"));
