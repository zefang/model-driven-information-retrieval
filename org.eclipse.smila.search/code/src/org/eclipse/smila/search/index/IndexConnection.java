...
public abstract class IndexConnection {
   ...
   */
  public abstract boolean docExists(String id) throws IndexException;
   ...
   */
  public abstract void deleteDocument(String id) throws IndexException;
   ...
   */
  public abstract void learnDocument(Blackboard blackboard, String id, Map<String, Integer> attributeMapping,
  ...
  protected abstract String[] getResultValues(final String id, final int fieldNo) throws IndexException;
    ...
    if (queryConstraints != null) {
      for (int i = 0; i < queryConstraints.getFieldConstraintsLength(); i++) {
        ...
        if (dFieldConstraints.getFieldTemplateCount() > 0) {
          ...
          for (final String fieldTemplate2 : fieldTemplates) {
        ...
        if (dFieldConstraints.getNodeTransformerCount() > 0) {
          ...
          for (final String nodeTransformer : nodeTransformers) {
        ...
        if (dFieldConstraints.getConstraintCount() > 0) {
          ...
          for (final String constraint2 : constraints) {
   ...
   * @return value
   */
  protected abstract Value createValue(DataFactory f, final int fieldNo, final String value) throws IndexException;
  ...
  protected abstract void addHighlightAnnotation(final IQueryExpression dQE, final String recordId,
    final AnyMap highlight, int fieldNo, final String attributeName, final String indexName) throws IndexException;
