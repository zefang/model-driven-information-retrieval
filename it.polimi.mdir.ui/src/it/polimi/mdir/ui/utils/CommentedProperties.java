package it.polimi.mdir.ui.utils;
...
public class CommentedProperties extends java.util.Properties {
	...
	private static final long serialVersionUID = -1726540268366852180L;
	 ...
	 * Overrides the load method in Properties so we can keep comment and blank lines.
	 * @param inStream   
	 ...
	 * 
	 * Overrides the store method in Properties so we can put back comment	
	 * and blank lines.													  
	 * 
	 * @param out
	 * The OutputStream to write to.
	 * @param header
	 * Ignored, it's here for compatability w/ Properties.
	 * 
